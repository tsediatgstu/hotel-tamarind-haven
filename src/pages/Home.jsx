...
function Home() {
  ...
  const heroImages = [
    ...
    '/c.png',
    '/sancu.jpg'   // Premium Wellness Sanctuary Atmosphere
  ];
  ...
  return (
    <div className="bg-[#FFFFFF] text-[#000000] font-sans antialiased">
      ...
      <div className="relative min-h-[90vh] lg:min-h-screen flex flex-col justify-between bg-[#FDFDFB] overflow-hidden border-b border-neutral-200">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto pt-32 pb-20 flex justify-center text-center">
          <div className="max-w-2xl flex flex-col items-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl font-serif tracking-wide leading-relaxed mb-12 text-[#2B7A4B]">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full sm:w-auto">
              <Link 
                to="/book" 
                className="w-full sm:w-auto bg-[#2B7A4B] text-white px-10 py-4.5 text-xs uppercase tracking-[0.25em] font-black rounded-none shadow-lg hover:bg-[#1C2E24] transition-all duration-400 transform active:scale-[0.99] border border-[#2B7A4B] hover:border-[#1C2E24] text-center"
              >
                Book A Stay
              </Link>
              <Link 
                to="/accommodations" 
                className="w-full sm:w-auto bg-transparent text-[#2B7A4B] px-10 py-4.5 text-xs uppercase tracking-[0.25em] font-black rounded-none hover:bg-[#2B7A4B] hover:text-white transition-all duration-400 transform active:scale-[0.99] border-2 border-[#2B7A4B] text-center"
              >
        ...
        <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-10 hidden lg:flex items-center justify-center">
          <div className="flex items-center space-x-4 bg-[#FDFDFB] px-5 py-2.5 border border-neutral-200 shadow-sm">
            <span className="text-[10px] uppercase tracking-widest text-[#2B7A4B]/60 font-mono">0{currentImageIndex + 1}</span>
            ...
            <span className="text-[10px] uppercase tracking-widest text-[#2B7A4B]/60 font-mono">0{heroImages.length}</span>
          </div>
        </div>
      </div>

      {/* ================= BRAND CONNECTION BAR ================= */}
      <div className="bg-[#2B7A4B] border-b border-[#2B7A4B]/30 text-[#FDFDFB] py-6 relative z-20 shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-6">
          <button className="flex items-center space-x-3.5 text-xs tracking-[0.2em] bg-[#1C2E24] text-white px-5 py-3 border border-[#1C2E24] hover:bg-transparent hover:text-white transition-all duration-300 rounded-none cursor-pointer">
            <span className="inline-block w-2 h-2 rounded-none bg-white animate-pulse" />
            <span>"24/7 Global Guest Services & Dedicated Support"</span>
          </button>
        </div>
      </div>
      ...
      <section className="max-w-5xl mx-auto py-15 px-2 sm:px-4">
        <div className="bg-[#FDFDFB] border border-[#2B7A4B]/18 p-6 sm:p-4 shadow-lg rounded-sm text-center">
          ...
          <h2 className="text-4xl sm:text-3xl tracking-wide max-w-4xl mx-auto leading-tight mb-6 font-serif italic text-[#2B7A4B]">
            <span className="font-bold not-italic tracking-[0.02em]">
              "Serve With Heart, Lead With Pride, Grow With Purpose."
            </span>
          </h2>
          <div className="font-maiandra text-[#000000] text-justify leading-relaxed max-w-4xl mx-auto p-6 bg-[#FFFFFF]">
            <p className="mb-6 text-lg">
              Welcome to <strong className="text-[#2B7A4B]">Hotel Tamarind Haven</strong>. At Tamarind Haven, we believe true luxury is a deep immersion. 
            ...
            <p className="mb-6 text-lg">
              The very identity of our hotel is inspired by the majestic <strong className="text-[#2B7A4B]">Tamarind Tree</strong>, which stands 
            ...
            <h2 className="text-2xl font-bold text-[#2B7A4B] mb-4">
              Our promise: "Serve With Heart, Lead With Pride, Grow With Purpose."
            </h2>
            <ul className="list-none mb-8 space-y-4 text-lg">
              <li><strong className="text-[#2B7A4B]">• We Serve With Heart:</strong> Grounded in the legendary warmth of Ethiopian hospitality, our service is deeply personal, intuitive, and genuine—ensuring you feel entirely at home from the moment you step through our doors.</li>
              <li><strong className="text-[#2B7A4B]">• We Lead With Pride:</strong> Like the wide-reaching crown of the Tamarind tree, we take immense pride in showcasing the absolute best of our rich culture, architectural elegance, and world-class service standards on a global stage.</li>
              <li><strong className="text-[#2B7A4B]">• We Grow With Purpose:</strong> Driven by deep roots and intentional excellence, we continuously evolve our spaces and experiences to create a meaningful, lasting, and unshakable impact for our guests and our community.</li>
            </ul>
            ...
            <h2 className="text-2xl font-bold text-[#2B7A4B] mb-6">
              Premium Outlets for Unforgettable Memories:
            </h2>
            <ul className="list-none space-y-4 text-lg mb-8">
              <li><strong className="text-[#2B7A4B]">120 Luxury Guest Rooms and Suites:</strong> Beautifully balancing minimalist styling with bespoke local artistry and smart-comfort amenities.</li>
              <li><strong className="text-[#2B7A4B]">3 Signature Dining Outlets and Culinary Lounges:</strong> Showcasing a masterfully curated fusion of international fine dining, a vibrant rooftop lounge experience, and a modern tribute to the legendary Ethiopian coffee ceremony.</li>
              <li><strong className="text-[#2B7A4B]">8 State-of-the-Art Conference Halls and Meeting Rooms:</strong> Scalable, premium venues fully equipped with advanced projectors, high-end PA systems, and high-speed Wi-Fi to flawlessly elevate your corporate events.</li>
              <li><strong className="text-[#2B7A4B]">1 Fully Equipped Wellness Center and Spa:</strong> Designed as a tranquil haven featuring a professional-grade fitness center, private steam and sauna rooms, and rejuvenating treatments.</li>
              <li><strong className="text-[#2B7A4B]">1 Executive Business Center:</strong> Providing a quiet, high-speed, and fully connected workspace tailored specifically for the discerning corporate traveler.</li>
            </ul>
            <p className="text-center font-bold text-xl italic text-[#2B7A4B] pt-6 border-t-2 border-[#2B7A4B]">
...
{/* ================= GRID: FEATURED SERVICES & LUXURY PATHWAYS ================= */}
      <section className="bg-[#FBFBFA] border-t border-b border-neutral-100 py-32 shadow-inner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-24">
            <h3 className="text-[10px] sm:text-xs uppercase tracking-[0.35em] text-[#2B7A4B] font-black mb-3">Refined Offerings</h3>
            <p className="text-2xl sm:text-4xl font-serif font-light text-[#2B7A4B] tracking-wide">Distinguished Amenities & Services</p>
            {/* Decorative Center Element */}
            <div className="flex items-center justify-center mt-8 gap-4">
              <div className="w-8 h-[1px] bg-[#2B7A4B]/30" />
              <div className="w-2 h-2 rotate-45 border border-[#2B7A4B]/30" />
              <div className="w-8 h-[1px] bg-[#2B7A4B]/30" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14">
            ...
            <Link to="/dining-nightlife" className="group bg-[#FFFFFF] p-6 rounded-none border border-neutral-200/60 hover:border-[#2B7A4B]/40 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col justify-between">
              <div>
                <div className="overflow-hidden mb-8 bg-[#2B7A4B] aspect-[4/3] rounded-none relative">
                  <img src="/a.png" alt="Meeting & Event Venues" className="w-full h-full object-cover opacity-85 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                </div>
                <h4 className="text-base font-black uppercase tracking-widest mb-4 text-[#2B7A4B] group-hover:text-[#2B7A4B] transition-colors text-center">
                  <span>Meetings & Events</span>
                </h4>
              </div>
              <div className="text-[10px] uppercase tracking-[0.2em] font-black text-[#2B7A4B] mt-8 text-center block group-hover:translate-x-1 transition-transform duration-300">
                View Venues & Capacity &rarr;
              </div>
            </Link>

            {/* Feature Item 2: Luxury Services */}
            <Link to="/Services" className="group bg-[#FFFFFF] p-5 rounded-none border border-neutral-200/60 hover:border-[#2B7A4B]/40 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col justify-between">
              <div>
                <div className="overflow-hidden mb-8 bg-[#2B7A4B] aspect-[4/3] rounded-none relative">
                  <img src="/b.png" alt="Premium Services" className="w-full h-full object-cover opacity-85 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                </div>
                <h4 className="text-base font-black uppercase tracking-widest mb-3 text-[#2B7A4B] group-hover:text-[#2B7A4B] transition-colors text-center">
                  <span>Signature Services</span> 
                </h4>
              </div>
              <div className="text-[10px] uppercase tracking-widest font-black text-[#2B7A4B] mt-6 text-center block group-hover:translate-x-1 transition-transform duration-300">
                Explore Our Hospitality &rarr;
              </div>
            </Link>
            ...
            <Link to="/wellness" className="group bg-[#FFFFFF] p-5 rounded-none border border-neutral-200/60 hover:border-[#2B7A4B]/40 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col justify-between">
              <div>
                <div className="overflow-hidden mb-8 bg-[#2B7A4B] aspect-[4/3] rounded-none relative">
                  <img src="/c.png" alt="Wellness Sanctuary" className="w-full h-full object-cover opacity-85 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                </div>
                <h4 className="text-base font-black uppercase tracking-widest mb-3 text-[#2B7A4B] group-hover:text-[#2B7A4B] transition-colors text-center">
      ...
      <div className="flex flex-col items-center gap-4 py-6 bg-[#2B7A4B]">
        {/* Social Platforms */}
        <div className="flex flex-wrap items-center justify-center gap-6 text-[11px] font-black uppercase tracking-[0.25em]">
          {[
            ...
            <a key={social.name} href={social.link} target="_blank" rel="noreferrer" 
               className="flex flex-col items-center gap-2 text-white hover:text-[#1C2E24] transition-all">
