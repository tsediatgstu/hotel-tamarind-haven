...
function RoomCard({ title, inventory, highlights, description }) {
  ...
  return (
    <div className="bg-[#2633CB] rounded-lg shadow-md border border-[#2B7A4B]/20 overflow-hidden flex flex-col h-full transition-transform duration-300 hover:shadow-xl">
      {/* Image Gallery Showcase Placeholder */}
      <div className="h-52 bg-[#2633CB] flex items-center justify-center text-neutral-400 font-medium border-b border-[#2B7A4B]/10 tracking-widest uppercase text-xs">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-start mb-2 gap-4">
          <h3 className="text-xl font-bold text-[#2633CB] tracking-wide">{title}</h3>
          <span className="text-[10px] font-bold uppercase tracking-wider bg-[#2633CB] text-[#2B7A4B] px-2.5 py-1 rounded-full whitespace-nowrap">
            Inventory: {inventory}
          </span>
        </div>
